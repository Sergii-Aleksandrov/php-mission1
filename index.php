...
//перебираем циклом нужное количество дочерних элементов 
for ($i = 1; $i <= 10; $i++) {
	...
	//создание необходимого количества дочерних элементов
	for ($j = 1; $j <= 2; $j++) {
		//добавление элемента <display-name> в <channel> 
		$display_name = $channel->appendChild($dom->createElement('display-name'));
		
		//создание атрибута lang
		...
		//добавление текста в <display-name>
